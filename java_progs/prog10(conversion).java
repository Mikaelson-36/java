...
import java.util.*;public class CurrencyCon
{
double inr,usd;
double euro,yen;
...
{
System.out.print("Enter in km");km=sc.nextDouble();
miles=(km*0.621371);
...
int choice,ch;
CurrencyCon c=new CurrencyCon();
DistanceCon d=new DistanceCon();
